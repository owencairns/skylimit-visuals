          ...
          <div className="md:w-2/3">
            ...
            {editedPackage ? (
              <div className="space-y-4">
                      ...
                      <div key={index} className="flex gap-2">
                        <div className="flex-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-blue/50"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Package Image{(activeTab === 'add' || editedPackage.isNew) && '*'}
                  </label>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className={(activeTab === 'edit' && !editedPackage.isNew && editedPackage.imageUrl) ? "w-2/3" : "w-full"}>
                      <p className="text-sm text-gray-500 mb-1">
                        {(activeTab === 'edit' && !editedPackage.isNew) ? "Upload New Image" : "Upload Image"}
                      </p>
                      <div 
